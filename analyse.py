...
def affichage_ana():
    st.markdown("""
                ...
                <h3>A - Analyse des incidents en fonction des variables temporelles </h3> 
                <br/>
    ...
    st.markdown("""
                ...
                <br/>
                <h3>B - Analyse en fonction du type d'incident </h3> 
    ...
    st.markdown("""
                ...
                <br/>
                <h3>C - Analyse en fonction de la localisation de l'incident </h3> 
    ...
    st.markdown("""           
                ...
                <h3>D - Autres tests statistiques réalisés </h3> 
                ...
                <h3>E - Conclusion sur l'analyse des données</h3> 
