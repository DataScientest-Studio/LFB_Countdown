...
def affichage_ana():
    st.markdown("""
                ...
                <h2>A - Analyse des incidents en fonction des variables temporelles </h2> 
                <br/>
    ...
    st.markdown("""
                ...
                <br/>
                <h2>B - Analyse en fonction du type d'incident </h2> 
    ...
    st.markdown("""
                ...
                <br/>
                <h2>C - Analyse en fonction de la localisation de l'incident </h2> 
    ...
    st.markdown("""           
                ...
                <h2>D - Autres tests statistiques réalisés </h2> 
                ...
                <h2>E - Conclusion sur l'analyse des données</h2> 
